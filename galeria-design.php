...
<div class="relative bg-hannah-dark py-20 mt-20"> 
    <div class="container mx-auto px-6 text-center relative z-10">
        <h1 class="text-4xl font-bold text-white mb-2">Galeria de Design</h1>
        <p class="text-blue-200 text-lg">Confira os detalhes de alguns dos nossos trabalhos de design</p>
